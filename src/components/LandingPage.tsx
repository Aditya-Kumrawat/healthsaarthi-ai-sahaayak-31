      ...
      <div className="container mx-auto px-4 sm:px-8 py-3">
        <div className="flex items-center justify-between flex-wrap">
          ...
          <div className="hidden md:flex items-center space-x-7 font-medium text-base font-poppins">
            ...
            <Button variant="outline" onClick={onLogin} className="font-medium border-2 border-primary/40 rounded-lg px-5 py-1.5 bg-white/80 hover:bg-white text-primary shadow transition">
              Login
            </Button>
          </div>
        </div>
    ...
    <section className="relative flex flex-col items-center justify-center overflow-hidden pt-36 md:pt-40 pb-12 min-h-[60vh]">
      ...
      <div className="relative z-10 w-full max-w-3xl text-center px-4 sm:px-8">
        ...
        <div className="flex flex-col sm:flex-row gap-5 justify-center items-center mb-6">
          <Button onClick={onGetStarted} className="btn-premium text-lg px-8 py-4 sm:px-10 sm:py-5 font-poppins">
            Get Started Free
    ...
    <section className="py-20 sm:py-24 px-3 sm:px-6 bg-gradient-to-br from-muted-gold/10 via-lavender-blue/10 to-soft-coral/10">
      <div className="container mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-5 sm:gap-6 justify-center">
          <Button onClick={onLogin} className="btn-coral text-lg px-8 py-4 sm:px-10 sm:py-6">
            Sign In
          </Button>
        </div>
      </div>
      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center space-x-3 mb-4 md:mb-0">
            <div className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-muted-gold to-yellow-400 rounded-xl flex items-center justify-center">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground -mt-1">Premium Healthcare</div>
            </div>
          </div>
          <div className="flex space-x-5 sm:space-x-8 text-foreground/60 text-sm sm:text-base">
            <a href="#" className="hover:text-muted-gold transition-colors font-medium">Privacy</a>
            <a href="#" className="hover:text-muted-gold transition-colors font-medium">Terms</a>
            <a href="#" className="hover:text-muted-gold transition-colors font-medium">Support</a>
          </div>
        </div>
        <div className="border-t border-white/10 mt-8 sm:mt-12 pt-5 sm:pt-8 text-center text-foreground/50 text-xs sm:text-base">
          <p>&copy; 2024 HealthSaarthi. All rights reserved. Crafted with care for your health.</p>
        </div>
      </div>
    </footer>
  </div>;
